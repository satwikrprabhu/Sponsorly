...
const About = () => {
  ...
  <div className='md:w-1/4 flex justify-center'>
    <img src={Frame} alt="" className='md:ml-24 mx-auto mt-6 md:mt-0 mb-6 md:mb-0 w-1/2 md:w-full shadow-lg shadow-indigo-500/200' />
  </div>
