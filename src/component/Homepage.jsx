...
export default function Homepage() {
  ...
  <div className="mx-auto max-w-3xl md:max-w-5xl lg:max-w-7xl md:px-8 lg:px-16 md:py-12 ml-4 ">
    <p className="tracking-widest text-green-0 text-[1.1rem] pr-4 md:text-base text-left font-semibold mb-12 md:mb-12">NOW ADVERTISE YOUR PRODUCTS ON SOCIAL MEDIA WITH SPONSORLY</p>
