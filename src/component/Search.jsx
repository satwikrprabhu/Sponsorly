...
function Search() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-primary text-center">
      <h1 className="text-5xl md:text-7xl font-bold mt-10 text-green-500 md:text-left">Welcome to Sponserly</h1>
      <p className="text-2xl md:text-4xl mt-6 text-green-500 md:text-left">Are you an influencer or advertiser?</p>
